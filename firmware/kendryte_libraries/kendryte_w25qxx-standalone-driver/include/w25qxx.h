...
w25qxx_status_t w25qxx_write_data_dma(uint32_t addr, uint8_t *data_buf,
                                      uint32_t length);
w25qxx_status_t w25qxx_write_data_direct_dma(uint32_t addr, uint8_t *data_buf,
                                             uint32_t length);
w25qxx_status_t w25qxx_read_data_dma(uint32_t addr, uint8_t *data_buf,
                                     uint32_t length, w25qxx_read_t mode);
