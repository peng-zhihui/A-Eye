...
typedef enum { KLF_NONE = 0, KLF_MAIN_MEM_OUT = 1 } kpu_model_layer_flags_t;

typedef enum { KLP_SAME = 0, KLP_VALID = 1 } kpu_model_padding_t;
 ...
 */
int kpu_run(kpu_task_t *task, dmac_channel_number_t dma_ch, const void *src,
